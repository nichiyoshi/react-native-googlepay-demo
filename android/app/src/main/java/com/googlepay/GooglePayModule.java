...
public class GooglePayModule extends ReactContextBaseJavaModule {
     ...
     */
    @ReactMethod
    public void possiblyShowGooglePayButton(int environment, ReadableArray cardNetworks ,final Promise promise) {
     ...
     */
    @ReactMethod
    public void requestPayment(int environment, ReadableMap requestData, final Promise promise) {
